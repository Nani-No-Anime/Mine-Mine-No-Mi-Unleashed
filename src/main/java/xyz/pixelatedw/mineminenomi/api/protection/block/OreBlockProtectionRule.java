...
public class OreBlockProtectionRule extends BlockProtectionRule {
  ...
  public OreBlockProtectionRule() {
    ...
    addApprovedBlocks(new Block[] { Blocks.COAL_ORE, Blocks.IRON_ORE, Blocks.GOLD_ORE, Blocks.DIAMOND_ORE, Blocks.EMERALD_ORE, Blocks.REDSTONE_ORE, Blocks.LAPIS_ORE, Blocks.NETHER_QUARTZ_ORE });
  }
}
