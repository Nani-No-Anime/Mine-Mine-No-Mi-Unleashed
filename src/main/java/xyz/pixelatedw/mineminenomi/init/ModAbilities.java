...
/*     */ {
/* 436 */   public static final AkumaNoMiItem RYU_RYU_NO_MI_ALLOSAURUS = new AkumaNoMiItem("Ryu Ryu no Mi, Model: Allosaurus", 2, FruitType.ANCIENT_ZOAN, new Ability[] { (Ability)AllosaurusWalkPointAbility.INSTANCE, (Ability)AllosaurusHeavyPointAbility.INSTANCE, (Ability)AncientBiteAbility.INSTANCE, (Ability)AncientTailSpinAbility.INSTANCE });
/* 437 */   public static final AkumaNoMiItem SAI_SAI_NO_MI = new AkumaNoMiItem("Sai Sai no Mi", 2, FruitType.ZOAN, new Ability[] { (Ability)SaiWalkPointAbility.INSTANCE, (Ability)SaiHeavyPointAbility.INSTANCE, (Ability)RhinoSmashAbility.INSTANCE, (Ability)HornDashAbility.INSTANCE });
/* 438 */   public static final AkumaNoMiItem SARA_SARA_NO_MI_AXOLOTL = new AkumaNoMiItem("Sara Sara no Mi, Model: Axolotl", 2, FruitType.ZOAN, new Ability[] { (Ability)AxolotlHeavyPointAbility.INSTANCE, (Ability)AxolotlWalkPointAbility.INSTANCE, (Ability)PoisonSpitAbility.INSTANCE, (Ability)AxolotlHealAbility.INSTANCE, (Ability)PlayDeadAbility.INSTANCE, (Ability)HeartRegenAbility.INSTANCE });
/* 439 */   public static final AkumaNoMiItem RYU_RYU_NO_MI_BRACHIOSAURUS = new AkumaNoMiItem("Ryu Ryu no Mi, Model: Brachiosaurus", 2, FruitType.ANCIENT_ZOAN, new Ability[] { (Ability)BrachiosaurusGuardPointAbility.INSTANCE, (Ability)BrachiosaurusHeavyPointAbility.INSTANCE, (Ability)BrachioBomberAbility.INSTANCE, (Ability)BrachioGrabAbility.INSTANCE });
/* 440 */   public static final AkumaNoMiItem RYU_RYU_NO_MI_PTERANODON = new AkumaNoMiItem("Ryu Ryu no Mi, Model: Pteranodon", 2, FruitType.ANCIENT_ZOAN, new Ability[] { (Ability)PteranodonFlyPointAbility.INSTANCE, (Ability)PteranodonAssaultPointAbility.INSTANCE, (Ability)TempuraudonAbility.INSTANCE, (Ability)TankyudonAbility.INSTANCE, (Ability)BarizodonAbility.INSTANCE, (Ability)PteranodonFlightAbility.INSTANCE, (Ability)PteranodonSmashAbility.INSTANCE });
/* 441 */   public static final AkumaNoMiItem KAME_KAME_NO_MI = new AkumaNoMiItem("Kame Kame no Mi", 1, FruitType.ZOAN, new Ability[] { (Ability)KameGuardPointAbility.INSTANCE, (Ability)KameWalkPointAbility.INSTANCE });
/* 442 */   public static final AkumaNoMiItem NEKO_NEKO_NO_MI_LEOPARD = new AkumaNoMiItem("Neko Neko no Mi, Model: Leopard", 2, FruitType.ZOAN, new Ability[] { (Ability)LeopardWalkPointAbility.INSTANCE, (Ability)LeopardHeavyPointAbility.INSTANCE, (Ability)FerociousLeapAbility.INSTANCE, (Ability)ClawStrikeAbility.INSTANCE });
/* 443 */   public static final AkumaNoMiItem ZOU_ZOU_NO_MI_MAMMOTH = new AkumaNoMiItem("Zou Zou no Mi, Model: Mammoth", 2, FruitType.ANCIENT_ZOAN, new Ability[] { (Ability)MammothGuardPointAbility.INSTANCE, (Ability)MammothHeavyPointAbility.INSTANCE, (Ability)TrampleAbility.INSTANCE, (Ability)AncientStompAbility.INSTANCE, (Ability)AncientSweepAbility.INSTANCE, (Ability)AncientTrunkShotAbility.INSTANCE });
/* 444 */   public static final AkumaNoMiItem HITO_HITO_NO_MI = new AkumaNoMiItem("Hito Hito no Mi", 1, FruitType.ZOAN, new Ability[0]);
/* 445 */   public static final AkumaNoMiItem USHI_USHI_NO_MI_GIRAFFE = new AkumaNoMiItem("Ushi Ushi no Mi, Model: Giraffe", 1, FruitType.ZOAN, new Ability[] { (Ability)GiraffeHeavyPointAbility.INSTANCE, (Ability)GiraffeWalkPointAbility.INSTANCE, (Ability)BiganAbility.INSTANCE });
/* 446 */   public static final AkumaNoMiItem MOGU_MOGU_NO_MI = new AkumaNoMiItem("Mogu Mogu no Mi", 1, FruitType.ZOAN, new Ability[] { (Ability)MoguHeavyPointAbility.INSTANCE, (Ability)MoguraBananaAbility.INSTANCE, (Ability)MoguraTonpoAbility.INSTANCE });
/* 447 */   public static final AkumaNoMiItem USHI_USHI_NO_MI_BISON = new AkumaNoMiItem("Ushi Ushi no Mi, Model: Bison", 2, FruitType.ZOAN, new Ability[] { (Ability)BisonHeavyPointAbility.INSTANCE, (Ability)BisonWalkPointAbility.INSTANCE, (Ability)FiddleBanffAbility.INSTANCE, (Ability)KokuteiCrossAbility.INSTANCE, (Ability)BisonSmashAbility.INSTANCE });
/* 448 */   public static final AkumaNoMiItem ZOU_ZOU_NO_MI = new AkumaNoMiItem("Zou Zou no Mi", 2, FruitType.ZOAN, new Ability[] { (Ability)ZouGuardPointAbility.INSTANCE, (Ability)ZouHeavyPointAbility.INSTANCE, (Ability)TrunkShotAbility.INSTANCE, (Ability)GreatStompAbility.INSTANCE, (Ability)IvoryDartAbility.INSTANCE, (Ability)IvoryStompAbility.INSTANCE });
/* 449 */   public static final AkumaNoMiItem HITO_HITO_NO_MI_DAIBUTSU = new AkumaNoMiItem("Hito Hito no Mi, Model: Daibutsu", 3, FruitType.MYTHICAL_ZOAN, new Ability[] { (Ability)HitoDaibutsuPointAbility.INSTANCE, ImpactBlastAbility.INSTANCE });
/* 450 */   public static final AkumaNoMiItem TORI_TORI_NO_MI_PHOENIX = new AkumaNoMiItem("Tori Tori no Mi, Model: Phoenix", 3, FruitType.MYTHICAL_ZOAN, new Ability[] { (Ability)PhoenixAssaultPointAbility.INSTANCE, (Ability)PhoenixFlyPointAbility.INSTANCE, (Ability)PhoenixGoenAbility.INSTANCE, (Ability)SaiseiNoHonoAbility.INSTANCE, (Ability)FujiazamiAbility.INSTANCE, (Ability)TenseiNoSoenAbility.INSTANCE, (Ability)BlueBirdAbility.INSTANCE, (Ability)FlamesOfRegenerationAbility.INSTANCE, (Ability)PhoenixFlightAbility.INSTANCE });
/*     */   
/* 452 */   public static final AkumaNoMiItem MANE_MANE_NO_MI = new AkumaNoMiItem("Mane Mane no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)ManeManeMemoryAbility.INSTANCE });
/* 453 */   public static final AkumaNoMiItem MEGA_MEGA_NO_MI = new AkumaNoMiItem("Mega Mega no Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)MegaMegaAbility.INSTANCE });
/* 454 */   public static final AkumaNoMiItem KARU_KARU_NO_MI = new AkumaNoMiItem("Karu Karu no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)IngaZarashiAbility.INSTANCE, (Ability)KarmaAbility.INSTANCE });
/* 455 */   public static final AkumaNoMiItem JIKI_JIKI_NO_MI = new AkumaNoMiItem("Jiki Jiki no Mi", 3, FruitType.PARAMECIA, new Ability[] { (Ability)AttractAbility.INSTANCE, (Ability)RepelAbility.INSTANCE, (Ability)PunkGibsonAbility.INSTANCE, (Ability)PunkPistolsAbility.INSTANCE, (Ability)PunkCornaDioAbility.INSTANCE, (Ability)DamnedPunkAbility.INSTANCE });
/*     */   
/* 457 */   public static final AkumaNoMiItem OTO_OTO_NO_MI = new AkumaNoMiItem("Oto Oto no Mi", 2, FruitType.PARAMECIA, new Ability[] { BonAbility.INSTANCE, DonAbility.INSTANCE, ShanAbility.INSTANCE });
/* 458 */   public static final AkumaNoMiItem BARA_BARA_NO_MI = new AkumaNoMiItem("Bara Bara No Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)BaraBaraHoAbility.INSTANCE, (Ability)BaraBaraFestivalAbility.INSTANCE, (Ability)KuchuKirimomiDaiCircusAbility.INSTANCE, (Ability)BaraBaraCarAbility.INSTANCE, (Ability)BaraSplitAbility.INSTANCE, (Ability)SlashDamageImmunityAbility.BARA_INSTANCE });
/* 459 */   public static final AkumaNoMiItem SUBE_SUBE_NO_MI = new AkumaNoMiItem("Sube Sube No Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)SubeSubeSpurAbility.INSTANCE, (Ability)SubeSubeDeflectAbility.INSTANCE, (Ability)PotionImmunitiesAbility.HANDCUFF_INSTANCE });
/* 460 */   public static final AkumaNoMiItem KOBU_KOBU_NO_MI = new AkumaNoMiItem("Kobu Kobu No Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)ShoureiAbility.INSTANCE, (Ability)PotionImmunitiesAbility.NEGATIVE_INSTANCE });
/* 461 */   public static final AkumaNoMiItem HANA_HANA_NO_MI = new AkumaNoMiItem("Hana Hana No Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)DosFleurClutchAbility.INSTANCE, (Ability)SeisFleurSlapAbility.INSTANCE, (Ability)SeisFleurTwistAbility.INSTANCE, (Ability)VeinteFleurCalendulaAbility.INSTANCE, (Ability)CienFleurWingAbility.INSTANCE, (Ability)CienFleurStompAbility.INSTANCE, (Ability)MilFleurAbility.INSTANCE });
/* 462 */   public static final AkumaNoMiItem MINI_MINI_NO_MI = new AkumaNoMiItem("Mini Mini No Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)MiniMiniAbility.INSTANCE, (Ability)PaperFloatAbility.INSTANCE });
/* 463 */   public static final AkumaNoMiItem HISO_HISO_NO_MI = new AkumaNoMiItem("Hiso Hiso No Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)ForewarnAbility.INSTANCE, (Ability)LookoutAbility.INSTANCE, (Ability)AnimalFriendAbility.INSTANCE });
/* 464 */   public static final AkumaNoMiItem KUKU_KUKU_NO_MI = new AkumaNoMiItem("Kuku Kuku no Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)GourmetamorphosisAbility.INSTANCE, (Ability)GastronomorphAbility.INSTANCE, (Ability)GourmetSnipeAbility.INSTANCE });
/* 465 */   public static final AkumaNoMiItem KIRA_KIRA_NO_MI = new AkumaNoMiItem("Kira Kira no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)DiamondBodyAbility.INSTANCE, (Ability)BrilliantPunkAbility.INSTANCE, (Ability)CabochonKnuckleAbility.INSTANCE });
/*     */   
/* 467 */   public static final AkumaNoMiItem BETA_BETA_NO_MI = new AkumaNoMiItem("Beta Beta no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)BetaCoatingAbility.INSTANCE, BetaLauncherAbility.INSTANCE, (Ability)HanamizuShinkenAbility.INSTANCE, (Ability)BetaBetaChainAbility.INSTANCE, (Ability)PotionImmunitiesAbility.BETA_INSTANCE });
/* 468 */   public static final AkumaNoMiItem NAGI_NAGI_NO_MI = new AkumaNoMiItem("Nagi Nagi no Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)SilentAbility.INSTANCE });
/* 469 */   public static final AkumaNoMiItem PERO_PERO_NO_MI = new AkumaNoMiItem("Pero Pero no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)CandyManAbility.INSTANCE, (Ability)CandyWallAbility.INSTANCE, (Ability)CandyEscalatorAbility.INSTANCE, (Ability)CandyWaveAbility.INSTANCE, (Ability)CandyArmorAbility.INSTANCE, (Ability)PotionImmunitiesAbility.PERO_INSTANCE });
/* 470 */   public static final AkumaNoMiItem NETSU_NETSU_NO_MI = new AkumaNoMiItem("Netsu Netsu no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)NetsuEnhancementAbility.INSTANCE, (Ability)NekkaiJigokuAbility.INSTANCE, (Ability)NekkaiGyoraiAbility.INSTANCE, (Ability)HeatDenasshiAbility.INSTANCE, (Ability)PotionImmunitiesAbility.HEAT_INSTANCE });
/* 471 */   public static final AkumaNoMiItem SUI_SUI_NO_MI = new AkumaNoMiItem("Sui Sui no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)FreeSwimmingAbility.INSTANCE, (Ability)NekomimiPunchAbility.INSTANCE, (Ability)NyanNyanSuplexAbility.INSTANCE, (Ability)NyanNyanSuplexBabyBusterAbility.INSTANCE });
/*     */   
/* 473 */   public static final AkumaNoMiItem AWA_AWA_NO_MI = new AkumaNoMiItem("Awa Awa no Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)GoldenHourAbility.INSTANCE, (Ability)RelaxHourAbility.INSTANCE, SoapDefenseAbility.INSTANCE });
/*     */   
/* 475 */   public static final AkumaNoMiItem WARA_WARA_NO_MI = new AkumaNoMiItem("Wara Wara no Mi", 3, FruitType.PARAMECIA, new Ability[] { StrawManAbility.INSTANCE, (Ability)WarabideSwordAbility.INSTANCE, (Ability)LifeMinusAbility.INSTANCE });
/* 476 */   public static final AkumaNoMiItem KACHI_KACHI_NO_MI = new AkumaNoMiItem("Kachi Kachi no Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)EvaporateAbility.INSTANCE, (Ability)HotBoilingSpecialAbility.INSTANCE, (Ability)VulcanizationAbility.INSTANCE });
/* 477 */   public static final AkumaNoMiItem DOA_DOA_NO_MI = new AkumaNoMiItem("Doa Doa no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)DoorDoorAbility.INSTANCE, (Ability)KaitenDoorAbility.INSTANCE, (Ability)AirDoorAbility.INSTANCE });
/* 478 */   public static final AkumaNoMiItem CHIYU_CHIYU_NO_MI = new AkumaNoMiItem("Chiyu Chiyu no Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)HealingTouchAbility.INSTANCE, ChiyupopoAbility.INSTANCE, KenpopoAbility.INSTANCE, (Ability)TearsAbility.INSTANCE });
/* 479 */   public static final AkumaNoMiItem SABI_SABI_NO_MI = new AkumaNoMiItem("Sabi Sabi no Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)RustTouchAbility.INSTANCE, (Ability)RustBreakAbility.INSTANCE, (Ability)RustSkinAbility.INSTANCE });
/* 480 */   public static final AkumaNoMiItem YOMI_YOMI_NO_MI = new AkumaNoMiItem("Yomi Yomi no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)SoulParadeAbility.INSTANCE, (Ability)KasuriutaFubukiGiriAbility.INSTANCE, (Ability)YomiNoReikiAbility.INSTANCE, (Ability)PotionImmunitiesAbility.YOMI_INSTANCE });
/* 481 */   public static final AkumaNoMiItem BAKU_BAKU_NO_MI = new AkumaNoMiItem("Baku Baku no Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)BakuMunchAbility.INSTANCE, (Ability)BeroCannonAbility.INSTANCE, (Ability)BakuTsuihoAbility.INSTANCE, (Ability)BakuFactoryAbility.INSTANCE });
/* 482 */   public static final AkumaNoMiItem HORU_HORU_NO_MI = new AkumaNoMiItem("Horu Horu no Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)OnnaHormoneAbility.INSTANCE, (Ability)ChiyuHormoneAbility.INSTANCE, (Ability)TensionHormoneAbility.INSTANCE, (Ability)GanmenSeichoHormoneAbility.INSTANCE, (Ability)DeathWinkAbility.INSTANCE });
/* 483 */   public static final AkumaNoMiItem KILO_KILO_NO_MI = new AkumaNoMiItem("Kilo Kilo no Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)KiloPress1Ability.INSTANCE, (Ability)KiloPress10000Ability.INSTANCE, (Ability)KiloPunch5000Ability.INSTANCE });
/* 484 */   public static final AkumaNoMiItem GOE_GOE_NO_MI = new AkumaNoMiItem("Goe Goe no Mi", 1, FruitType.PARAMECIA, new Ability[] { TodorokiAbility.INSTANCE, (Ability)DragonsRoarAbility.INSTANCE });
/* 485 */   public static final AkumaNoMiItem MERO_MERO_NO_MI = new AkumaNoMiItem("Mero Mero no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)MeroMeroMellowAbility.INSTANCE, (Ability)PistolKissAbility.INSTANCE, (Ability)SlaveArrowAbility.INSTANCE, (Ability)PerfumeFemurAbility.INSTANCE });
/* 486 */   public static final AkumaNoMiItem ORI_ORI_NO_MI = new AkumaNoMiItem("Ori Ori no Mi", 1, FruitType.PARAMECIA, new Ability[] { (Ability)BindAbility.INSTANCE, (Ability)GreatCageAbility.INSTANCE, (Ability)AwaseBaoriAbility.INSTANCE });
/* 487 */   public static final AkumaNoMiItem SUPA_SUPA_NO_MI = new AkumaNoMiItem("Supa Supa no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)SpiderAbility.INSTANCE, (Ability)SparClawAbility.INSTANCE, (Ability)SpiralHollowAbility.INSTANCE, (Ability)SparklingDaisyAbility.INSTANCE, (Ability)AtomicSpurtAbility.INSTANCE });
/* 488 */   public static final AkumaNoMiItem HORO_HORO_NO_MI = new AkumaNoMiItem("Horo Horo no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)NegativeHollowAbility.INSTANCE, (Ability)MiniHollowAbility.INSTANCE, (Ability)TokuHollowAbility.INSTANCE, (Ability)YutaiRidatsuAbility.INSTANCE });
/* 489 */   public static final AkumaNoMiItem ITO_ITO_NO_MI = new AkumaNoMiItem("Ito Ito no Mi", 3, FruitType.PARAMECIA, new Ability[] { (Ability)ParasiteAbility.INSTANCE, (Ability)SoraNoMichiAbility.INSTANCE, (Ability)TamaitoAbility.INSTANCE, (Ability)FullbrightAbility.INSTANCE, (Ability)OverheatAbility.INSTANCE, (Ability)KumoNoSugakiAbility.INSTANCE, (Ability)TorikagoAbility.INSTANCE, (Ability)BlackKnightAbility.INSTANCE });
/* 490 */   public static final AkumaNoMiItem ZUSHI_ZUSHI_NO_MI = new AkumaNoMiItem("Zushi Zushi no Mi", 3, FruitType.PARAMECIA, new Ability[] { (Ability)JigokuTabiAbility.INSTANCE, (Ability)SagariNoRyuseiAbility.INSTANCE, (Ability)MokoAbility.INSTANCE, (Ability)AbareHimatsuriAbility.INSTANCE, (Ability)GraviZoneAbility.INSTANCE, (Ability)GraviPullAbility.INSTANCE });
...
/* 492 */   public static final AkumaNoMiItem DOKU_DOKU_NO_MI = new AkumaNoMiItem("Doku Doku no Mi", 3, FruitType.PARAMECIA, new Ability[] { (Ability)HydraAbility.INSTANCE, (Ability)ChloroBallAbility.INSTANCE, (Ability)DokuFuguAbility.INSTANCE, (Ability)VenomRoadAbility.INSTANCE, (Ability)DokuGumoAbility.INSTANCE, (Ability)VenomDemonAbility.INSTANCE, (Ability)PoisonToRegenAbility.INSTANCE });
/* 493 */   public static final AkumaNoMiItem DORU_DORU_NO_MI = new AkumaNoMiItem("Doru Doru no Mi", 2, FruitType.PARAMECIA, new Ability[] { CandleWallAbility.INSTANCE, CandleHouseAbility.INSTANCE, (Ability)DoruDoruArtsMoriAbility.INSTANCE, DoruDoruArtsKenAbility.INSTANCE, CandleLockAbility.INSTANCE, DoruDoruArtsPickaxeAbility.INSTANCE, (Ability)DoruDoruBallAbility.INSTANCE, (Ability)DoruDoruNoYakataAbility.INSTANCE, (Ability)CandleChampionAbility.INSTANCE });
/* 494 */   public static final AkumaNoMiItem KAGE_KAGE_NO_MI = new AkumaNoMiItem("Kage Kage no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)DoppelmanAbility.INSTANCE, (Ability)KagemushaAbility.INSTANCE, (Ability)BrickBatAbility.INSTANCE, (Ability)BlackBoxAbility.INSTANCE, (Ability)TsunoTokageAbility.INSTANCE, KageKakumeiAbility.INSTANCE, (Ability)KageGiriAbility.INSTANCE, (Ability)NightmareSoldiersAbility.INSTANCE, (Ability)ShadowsAsgardAbility.INSTANCE });
/* 495 */   public static final AkumaNoMiItem GURA_GURA_NO_MI = new AkumaNoMiItem("Gura Gura no Mi", 3, FruitType.PARAMECIA, new Ability[] { GekishinAbility.INSTANCE, (Ability)ShingenNoIchigekiAbility.INSTANCE, TenchiMeidoAbility.INSTANCE, ShimaYurashiAbility.INSTANCE, (Ability)PotionImmunitiesAbility.GURA_INSTANCE });
/* 496 */   public static final AkumaNoMiItem BOMU_BOMU_NO_MI = new AkumaNoMiItem("Bomu Bomu no Mi", 2, FruitType.PARAMECIA, new Ability[] { NoseFancyCannonAbility.INSTANCE, KickBombAbility.INSTANCE, (Ability)ZenshinKibakuAbility.INSTANCE, ExplosivePunchAbility.INSTANCE, (Ability)BreezeBreathBombAbility.INSTANCE });
/* 497 */   public static final AkumaNoMiItem NIKYU_NIKYU_NO_MI = new AkumaNoMiItem("Nikyu Nikyu no Mi", 2, FruitType.PARAMECIA, new Ability[] { PadHoAbility.INSTANCE, HanpatsuAbility.INSTANCE, TsuppariPadHoAbility.INSTANCE, UrsusShockAbility.INSTANCE, (Ability)PuniAbility.INSTANCE });
/* 498 */   public static final AkumaNoMiItem NORO_NORO_NO_MI = new AkumaNoMiItem("Noro Noro no Mi", 1, FruitType.PARAMECIA, new Ability[] { NoroNoroBeamAbility.INSTANCE, NoroNoroBeamSwordAbility.INSTANCE, KyubiRushAbility.INSTANCE });
/* 499 */   public static final AkumaNoMiItem OPE_OPE_NO_MI = new AkumaNoMiItem("Ope Ope no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)RoomAbility.INSTANCE, ShamblesAbility.INSTANCE, TaktAbility.INSTANCE, InjectionShotAbility.INSTANCE, CounterShockAbility.INSTANCE, MesAbility.INSTANCE, GammaKnifeAbility.INSTANCE });
/* 500 */   public static final AkumaNoMiItem SUKE_SUKE_NO_MI = new AkumaNoMiItem("Suke Suke no Mi", 1, FruitType.PARAMECIA, new Ability[] { SkattingAbility.INSTANCE, ShishaNoTeAbility.INSTANCE, SukePunchAbility.INSTANCE });
/* 501 */   public static final AkumaNoMiItem GOMU_GOMU_NO_MI = new AkumaNoMiItem("Gomu Gomu no Mi", 2, FruitType.PARAMECIA, new Ability[] { (Ability)GomuGomuNoPistolAbility.INSTANCE, (Ability)GomuGomuNoGatlingAbility.INSTANCE, (Ability)GomuGomuNoBazookaAbility.INSTANCE, (Ability)GomuGomuNoRocketAbility.INSTANCE, (Ability)GearSecondAbility.INSTANCE, (Ability)GearThirdAbility.INSTANCE, (Ability)GearFourthAbility.INSTANCE, (Ability)BouncyAbility.INSTANCE });
/* 502 */   public static final AkumaNoMiItem BANE_BANE_NO_MI = new AkumaNoMiItem("Bane Bane no Mi", 1, FruitType.PARAMECIA, new Ability[] { SpringHopperAbility.INSTANCE, SpringSnipeAbility.INSTANCE, SpringDeathKnockAbility.INSTANCE, (Ability)SpringMovementAbility.INSTANCE, (Ability)NoFallDamageAbility.INSTANCE });
/*     */ 
/*     */   
/* 505 */   public static final AkumaNoMiItem YUKI_YUKI_NO_MI = new AkumaNoMiItem("Yuki Yuki no Mi", 3, FruitType.LOGIA, new Ability[] { (Ability)KamakuraAbility.INSTANCE, (Ability)YukiRabiAbility.INSTANCE, (Ability)KamakuraJussoshiAbility.INSTANCE, (Ability)TabiraYukiAbility.INSTANCE, (Ability)YukiGakiAbility.INSTANCE, (Ability)FubukiAbility.INSTANCE, (Ability)YukiPassiveEvents.INVULNERABILITY_INSTANCE, (Ability)PotionImmunitiesAbility.YUKI_INSTANCE });
/* 506 */   public static final AkumaNoMiItem YAMI_YAMI_NO_MI = new AkumaNoMiItem("Yami Yami no Mi", 3, FruitType.LOGIA, new Ability[] { (Ability)BlackHoleAbility.INSTANCE, (Ability)BlackRoadAbility.INSTANCE, (Ability)LiberationAbility.INSTANCE, (Ability)KurouzuAbility.INSTANCE, (Ability)DarkMatterAbility.INSTANCE, (Ability)BlackWorldAbility.INSTANCE });
/* 507 */   public static final AkumaNoMiItem GASU_GASU_NO_MI = new AkumaNoMiItem("Gasu Gasu no Mi", 3, FruitType.LOGIA, new Ability[] { (Ability)GasRobeAbility.INSTANCE, (Ability)GastanetAbility.INSTANCE, (Ability)GastilleAbility.INSTANCE, BlueSwordAbility.INSTANCE, (Ability)KarakuniAbility.INSTANCE, (Ability)ShinokuniAbility.INSTANCE, (Ability)SpecialFlyAbility.INSTANCE, (Ability)PotionImmunitiesAbility.GASU_INSTANCE, (Ability)GasuPassiveEvents.INVULNERABILITY_INSTANCE });
/* 508 */   public static final AkumaNoMiItem MAGU_MAGU_NO_MI = new AkumaNoMiItem("Magu Magu no Mi", 3, FruitType.LOGIA, new Ability[] { DaiFunkaAbility.INSTANCE, RyuseiKazanAbility.INSTANCE, MeigoAbility.INSTANCE, BakuretsuKazanAbility.INSTANCE, LavaFlowAbility.INSTANCE, MagmaCoatingAbility.INSTANCE, (Ability)MaguPassiveEvents.INVULNERABILITY_INSTANCE, (Ability)PotionImmunitiesAbility.LOGIA_HEAT_INSTANCE });
/* 509 */   public static final AkumaNoMiItem SUNA_SUNA_NO_MI = new AkumaNoMiItem("Suna Suna no Mi", 3, FruitType.LOGIA, new Ability[] { DesertSpadaAbility.INSTANCE, DesertGrandeSpadaAbility.INSTANCE, SablesAbility.INSTANCE, (Ability)GrandeSablesAbility.INSTANCE, BarjanAbility.INSTANCE, DesertEncierroAbility.INSTANCE, GroundDeathAbility.INSTANCE, DesertGirasoleAbility.INSTANCE, (Ability)SpecialFlyAbility.INSTANCE, SablesPesadoAbility.INSTANCE, (Ability)SunaPassiveEvents.INVULNERABILITY_INSTANCE, (Ability)PotionImmunitiesAbility.LOGIA_INSTANCE });
/* 510 */   public static final AkumaNoMiItem GORO_GORO_NO_MI = new AkumaNoMiItem("Goro Goro no Mi", 3, FruitType.LOGIA, new Ability[] { SparkStepAbility.INSTANCE, (Ability)ElThorAbility.INSTANCE, VoltVariAbility.INSTANCE, KariAbility.INSTANCE, SangoAbility.INSTANCE, RaigoAbility.INSTANCE, (Ability)VoltAmaruAbility.INSTANCE, (Ability)GoroPassiveEvents.INVULNERABILITY_INSTANCE, (Ability)PotionImmunitiesAbility.LOGIA_HEAT_INSTANCE });
/* 511 */   public static final AkumaNoMiItem MOKU_MOKU_NO_MI = new AkumaNoMiItem("Moku Moku no Mi", 3, FruitType.LOGIA, new Ability[] { WhiteOutAbility.INSTANCE, WhiteSnakeAbility.INSTANCE, WhiteLauncherAbility.INSTANCE, WhiteStrikeAbility.INSTANCE, WhiteBlowRushAbility.INSTANCE, (Ability)WhiteGrabAbility.INSTANCE, (Ability)SpecialFlyAbility.INSTANCE, (Ability)WhitePullAbility.INSTANCE, (Ability)SmokeLaunchAbility.INSTANCE, (Ability)MokuPassiveEvents.INVULNERABILITY_INSTANCE, (Ability)PotionImmunitiesAbility.MOKU_INSTANCE });
/* 512 */   public static final AkumaNoMiItem PIKA_PIKA_NO_MI = new AkumaNoMiItem("Pika Pika no Mi", 3, FruitType.LOGIA, new Ability[] { YataNoKagamiAbility.INSTANCE, YasakaniNoMagatamaAbility.INSTANCE, AmaNoMurakumoAbility.INSTANCE, AmaterasuAbility.INSTANCE, FlashAbility.INSTANCE, (Ability)PikaPassiveEvents.INVULNERABILITY_INSTANCE, LightAccelerationAbility.INSTANCE, (Ability)PotionImmunitiesAbility.LOGIA_INSTANCE });
/* 513 */   public static final AkumaNoMiItem HIE_HIE_NO_MI = new AkumaNoMiItem("Hie Hie no Mi", 3, FruitType.LOGIA, new Ability[] { IceBlockPartisanAbility.INSTANCE, IceAgeAbility.INSTANCE, IceBallAbility.INSTANCE, IceSaberAbility.INSTANCE, IceTimeCapsuleAbility.INSTANCE, IceBlockPheasantAbility.INSTANCE, (Ability)IceBlockAvalancheAbility.INSTANCE, (Ability)HiePassiveEvents.INVULNERABILITY_INSTANCE, (Ability)FrostWalkerAbility.INSTANCE, (Ability)PotionImmunitiesAbility.HIE_INSTANCE });
/* 514 */   public static final AkumaNoMiItem MERA_MERA_NO_MI = new AkumaNoMiItem("Mera Mera no Mi", 3, FruitType.LOGIA, new Ability[] { HikenAbility.INSTANCE, HiganAbility.INSTANCE, DaiEnkaiEnteiAbility.INSTANCE, HidarumaAbility.INSTANCE, JujikaAbility.INSTANCE, (Ability)HeatDashAbility.INSTANCE, (Ability)KyokaenAbility.INSTANCE, (Ability)HibashiraAbility.INSTANCE, (Ability)MeraPassiveEvents.INVULNERABILITY_INSTANCE, (Ability)PotionImmunitiesAbility.LOGIA_HEAT_INSTANCE });
/*     */   
/* 516 */   public static final Ability[] HAKI_ABILITIES = new Ability[] { (Ability)BusoshokuHakiFullBodyHardeningAbility.INSTANCE, (Ability)BusoshokuHakiHardeningAbility.INSTANCE, (Ability)BusoshokuHakiImbuingAbility.INSTANCE, (Ability)HaoshokuHakiAbility.INSTANCE, (Ability)KenbunshokuHakiAuraAbility.INSTANCE, (Ability)KenbunshokuHakiFutureSightAbility.INSTANCE };
/*     */   
/* 518 */   public static final Ability[] MARINE_ABILITIES = new Ability[] { (Ability)SmallMusterAbility.INSTANCE, (Ability)MusterAbility.INSTANCE };
/*     */   
/* 520 */   public static final Ability[] HUMAN_ABILITIES = new Ability[] { SoruAbility.INSTANCE, TekkaiAbility.INSTANCE, ShiganAbility.INSTANCE, RankyakuAbility.INSTANCE, KamieAbility.INSTANCE, (Ability)GeppoAbility.INSTANCE, (Ability)RokuoganAbility.INSTANCE };
/* 521 */   public static final Ability[] FISHMAN_ABILITIES = new Ability[] { UchimizuAbility.INSTANCE, SamehadaShoteiAbility.INSTANCE, MurasameAbility.INSTANCE, KarakusagawaraSeikenAbility.INSTANCE, KachiageHaisokuAbility.INSTANCE, (Ability)TwoFishEngineAbility.INSTANCE, (Ability)YarinamiAbility.INSTANCE };
/* 522 */   public static final Ability[] CYBORG_ABILITIES = new Ability[] { StrongRightAbility.INSTANCE, RadicalBeamAbility.INSTANCE, FreshFireAbility.INSTANCE, CoupDeBooAbility.INSTANCE, CoupDeVentAbility.INSTANCE, ColaOverdriveAbility.INSTANCE };
/* 523 */   public static final Ability[] MINK_ABILITIES = new Ability[] { (Ability)EleclawAbility.INSTANCE, (Ability)ElectricalMissileAbility.INSTANCE, (Ability)ElectricalTempestaAbility.INSTANCE, (Ability)ElectricalShowerAbility.INSTANCE, (Ability)ElectricalLunaAbility.INSTANCE, (Ability)SulongAbility.INSTANCE };
/*     */   
/* 525 */   public static final Ability[] SWORDSMAN_ABILITIES = new Ability[] { (Ability)ShiShishiSonsonAbility.INSTANCE, YakkodoriAbility.INSTANCE, SanbyakurokujuPoundHoAbility.INSTANCE, OTatsumakiAbility.INSTANCE, (Ability)HiryuKaenAbility.INSTANCE };
/* 526 */   public static final Ability[] SNIPER_ABILITIES = new Ability[] { KaenBoshiAbility.INSTANCE, KemuriBoshiAbility.INSTANCE, (Ability)RenpatsuNamariBoshiAbility.INSTANCE, SakuretsuSabotenBoshiAbility.INSTANCE, TetsuBoshiAbility.INSTANCE, TokuyoAburaBoshiAbility.INSTANCE, NemuriBoshiAbility.INSTANCE };
/* 527 */   public static final Ability[] DOCTOR_ABILITIES = new Ability[] { (Ability)FirstAidAbility.INSTANCE, (Ability)MedicBagExplosionAbility.INSTANCE, FailedExperimentAbility.INSTANCE, (Ability)DopingAbility.INSTANCE };
/* 528 */   public static final Ability[] ART_OF_WEATHER_ABILITIES = new Ability[] { (Ability)HeatBallAbility.INSTANCE, (Ability)CoolBallAbility.INSTANCE, (Ability)WeatherCloudTempo.INSTANCE, (Ability)ThunderBallAbility.INSTANCE, (Ability)ThunderboltTempo.INSTANCE, (Ability)ThunderstormTempo.INSTANCE, (Ability)ThunderLanceTempo.INSTANCE, (Ability)FogTempo.INSTANCE, (Ability)MirageTempo.INSTANCE, (Ability)RainTempo.INSTANCE, (Ability)WeatherEggAbility.INSTANCE, (Ability)GustSwordAbility.INSTANCE };
/* 529 */   public static final Ability[] BLACK_LEG_ABILITIES = new Ability[] { (Ability)DiableJambeAbility.INSTANCE, (Ability)SkywalkAbility.INSTANCE, (Ability)AntiMannerKickCourseAbility.INSTANCE, (Ability)ExtraHachisAbility.INSTANCE, (Ability)PartyTableKickCourseAbility.INSTANCE, (Ability)ConcasseAbility.INSTANCE, (Ability)BienCuitGrillShotAbility.INSTANCE };
/* 530 */   public static final Ability[] BRAWLER_ABILITIES = new Ability[] { (Ability)GenkotsuMeteorAbility.INSTANCE, (Ability)KingPunchAbility.INSTANCE, (Ability)HakaiHoAbility.INSTANCE, (Ability)JishinHoAbility.INSTANCE, (Ability)SpinningBrawlAbility.INSTANCE, (Ability)SuplexAbility.INSTANCE };
/*     */ 
/*     */   
/*     */   static {
/* 534 */     for (AkumaNoMiItem df : ModValues.devilfruits) {
/*     */       
/* 536 */       WyRegistry.registerItem((Item)df, df.getDevilFruitName());
/* 537 */       registerAbilities(df.abilities);
/*     */     } 
/*     */     
/* 540 */     registerAbilities(HUMAN_ABILITIES);
/* 541 */     registerAbilities(FISHMAN_ABILITIES);
/* 542 */     registerAbilities(CYBORG_ABILITIES);
/* 543 */     registerAbilities(MINK_ABILITIES);
/*     */     
/* 545 */     registerAbilities(SWORDSMAN_ABILITIES);
/* 546 */     registerAbilities(SNIPER_ABILITIES);
/* 547 */     registerAbilities(DOCTOR_ABILITIES);
/* 548 */     registerAbilities(ART_OF_WEATHER_ABILITIES);
/* 549 */     registerAbilities(BLACK_LEG_ABILITIES);
/* 550 */     registerAbilities(BRAWLER_ABILITIES);
/*     */     
/* 552 */     registerAbilities(HAKI_ABILITIES);
/*     */     
/* 554 */     registerAbilities(MARINE_ABILITIES);
/*     */ 
/*     */     
/* 557 */     WyRegistry.registerAbility((Ability)ZoomAbility.INSTANCE);
/*     */ 
/*     */     
/* 560 */     WyRegistry.registerAbility((Ability)GunArrayAbility.INSTANCE);
/*     */ 
/*     */     
/* 563 */     WyRegistry.registerAbility((Ability)ColaBackpackBonusAbility.INSTANCE);
/*     */ 
/*     */     
/* 566 */     WyRegistry.registerAbility((Ability)ShinzoMassageAbility.INSTANCE);
/*     */   }
/*     */ 
/*     */   
/*     */   private static void registerAbilities(Ability[] abilities) {
/* 571 */     Arrays.<Ability>stream(abilities).filter(Objects::nonNull).forEach(WyRegistry::registerAbility);
/*     */   }
/*     */ }


/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\init\ModAbilities.class
