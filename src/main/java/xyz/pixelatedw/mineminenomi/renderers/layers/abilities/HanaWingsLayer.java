...
public class HanaWingsLayer<T extends LivingEntity, M extends EntityModel<T>>
  ...
  private HanaWingsModel model = new HanaWingsModel();
  ...
  public void render(MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight, T entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    Ability ability = abilityData.getEquippedAbility((Ability)CienFleurWingAbility.INSTANCE);
