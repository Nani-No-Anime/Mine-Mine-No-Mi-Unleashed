...
public class MinkBunnyPartialRenderer<T extends AbstractClientPlayerEntity, M extends ZoanMorphModel>
  ...
  private MinkBunnyPartialModel model = new MinkBunnyPartialModel();
  private ResourceLocation texture = new ResourceLocation("mineminenomi", "textures/models/zoanmorph/mink_bunny.png");
    ...
    implements IRenderFactory<T>
  {
    public EntityRenderer<? super T> createRenderFor(EntityRendererManager manager) {
      return (EntityRenderer)new MinkBunnyPartialRenderer<>(manager);
    }
  }
}
