...
public class MinkDogPartialRenderer<T extends AbstractClientPlayerEntity, M extends ZoanMorphModel>
  ...
  private MinkDogPartialModel model = new MinkDogPartialModel();
  private ResourceLocation texture = new ResourceLocation("mineminenomi", "textures/models/zoanmorph/mink_dog.png");
    ...
    implements IRenderFactory<T>
  {
    public EntityRenderer<? super T> createRenderFor(EntityRendererManager manager) {
      return (EntityRenderer)new MinkDogPartialRenderer<>(manager);
    }
  }
}
