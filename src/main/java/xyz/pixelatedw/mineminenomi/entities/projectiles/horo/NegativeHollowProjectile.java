...
public class NegativeHollowProjectile
  ...
  public NegativeHollowProjectile(World world, LivingEntity player) {
    ...
    this.withEffects = (() -> new EffectInstance[] { new EffectInstance(Effects.NAUSEA, 200, 1), new EffectInstance(Effects.SLOWNESS, 200, 1), new EffectInstance(ModEffects.NEGATIVE, 300, 1) });
  }
}
