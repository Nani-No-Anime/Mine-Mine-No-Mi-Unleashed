...
/*    */ 
/*    */ public class KaenBoshiGoal
/*    */   extends CooldownGoal {
/*    */   public KaenBoshiGoal(OPEntity entity) {
/* 14 */     super(entity, 60, entity.getRNG().nextInt(10));
/* 15 */     this.entity = entity;
/* 16 */     this.entity.addThreat(2);
/*    */   }
/*    */   
...
/*    */     
/* 49 */     KaenBoshiProjectile projectile = new KaenBoshiProjectile(this.entity.world, (LivingEntity)this.entity);
...
/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\entities\mobs\goals\abilities\sniper\KaenBoshiGoal.class
