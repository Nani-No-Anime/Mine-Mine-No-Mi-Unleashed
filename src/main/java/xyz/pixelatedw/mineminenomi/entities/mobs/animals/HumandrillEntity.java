...
/*  42 */   private static final DataParameter<Float> SIZE = EntityDataManager.createKey(HumandrillEntity.class, DataSerializers.FLOAT);
/*  43 */   private static final DataParameter<Boolean> ARMOR = EntityDataManager.createKey(HumandrillEntity.class, DataSerializers.BOOLEAN);
/*     */   
/*  45 */   protected static final Item[] SWORDS = new Item[] { (Item)ModWeapons.MARINE_SWORD, Items.IRON_SWORD, Items.STONE_SWORD, (Item)ModWeapons.SANDAI_KITETSU, (Item)ModWeapons.NIDAI_KITETSU, (Item)ModWeapons.WADO_ICHIMONJI, Items.DIAMOND_SWORD };
...
/*  49 */     setBelly(30.0D + WyHelper.randomWithRange(0, 20)); } public HumandrillEntity(World world) { super(ModEntities.HUMANDRILL, world);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     setBelly(0.0D); }
/* 138 */   public void tick() { super.tick(); }
/*     */ 
/*     */   
...
/* 150 */     super.writeAdditional(compound);
/* 151 */     compound.putFloat("size", ((Float)this.dataManager.get(SIZE)).floatValue());
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void readAdditional(CompoundNBT compound) {
/* 157 */     super.readAdditional(compound);
/* 158 */     this.dataManager.set(SIZE, Float.valueOf(compound.getFloat("size")));
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\entities\mobs\animals\HumandrillEntity.class
