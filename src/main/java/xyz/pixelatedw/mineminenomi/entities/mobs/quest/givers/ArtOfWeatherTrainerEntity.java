...
/*  37 */   private static final String[] DEFAULT_TEXTURES = new String[] { "weather_wizard1" };
/*     */ 
/*     */   
/*     */   public ArtOfWeatherTrainerEntity(World world) {
/*  41 */     super(ModEntities.ART_OF_WEATHER_TRAINER, world, DEFAULT_TEXTURES);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  62 */     getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).setBaseValue(0.2199999988079071D);
/*  63 */     getAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(2.0D);
...
/*     */     
/*  67 */     setDoriki(10.0D + WyHelper.randomWithRange(0, 10) + getThreat());
/*  68 */     setBelly(20.0D + WyHelper.randomWithRange(0, 10));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       
/*  91 */       ItemStack climaTact = new ItemStack((IItemProvider)ModWeapons.CLIMA_TACT);
/*  92 */       setItemStackToSlot(EquipmentSlotType.MAINHAND, climaTact);
/*     */     } 
/*     */     
/*  95 */     return spawnData;
/*     */   }
...
/*     */     
/* 104 */     if (entityProps.isWeatherWizard()) {
/* 105 */       availableQuests.addAll(Arrays.asList(ModQuests.ART_OF_WEATHER_TRIALS));
/*     */     }
...
/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\entities\mobs\quest\givers\ArtOfWeatherTrainerEntity.class
