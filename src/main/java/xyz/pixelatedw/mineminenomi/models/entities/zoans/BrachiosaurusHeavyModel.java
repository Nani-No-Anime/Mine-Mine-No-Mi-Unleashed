...
/*  53 */     this.head.setRotationPoint(0.0F, -2.0F, -5.75F);
/*     */     
/*  55 */     this.headBase = new ModelRenderer((Model)this);
/*  56 */     this.headBase.setRotationPoint(0.0F, 0.0F, 0.0F);
/*  57 */     this.head.addChild(this.headBase);
/*  58 */     this.headBase.setTextureOffset(0, 0).addBox(-2.5F, -11.75F, -9.0F, 5.0F, 6.0F, 2.0F, 0.01F, false);
/*     */     
/*  60 */     this.headBase3_r1 = new ModelRenderer((Model)this);
/*  61 */     this.headBase3_r1.setRotationPoint(0.0F, -8.0F, -9.0F);
/*  62 */     this.headBase.addChild(this.headBase3_r1);
/*  63 */     setRotationAngle(this.headBase3_r1, -0.0873F, 0.0F, 0.0F);
/*  64 */     this.headBase3_r1.setTextureOffset(0, 60).addBox(-2.5F, -3.5F, -1.5728F, 5.0F, 5.0F, 2.0F, 0.0F, false);
/*     */     
/*  66 */     this.headBase1_r1 = new ModelRenderer((Model)this);
/*  67 */     this.headBase1_r1.setRotationPoint(0.0F, -8.0392F, -6.2777F);
/*  68 */     this.headBase.addChild(this.headBase1_r1);
/*  69 */     setRotationAngle(this.headBase1_r1, 1.3963F, 0.0F, 0.0F);
/*  70 */     this.headBase1_r1.setTextureOffset(78, 31).addBox(-2.0F, -1.4992F, -2.5824F, 4.0F, 3.0F, 6.0F, 0.0F, false);
/*     */     
/*  72 */     this.neck = new ModelRenderer((Model)this);
/*  73 */     this.neck.setRotationPoint(0.0F, 0.0F, -0.1878F);
/*  74 */     this.head.addChild(this.neck);
/*     */     
/*  76 */     this.neck5_r1 = new ModelRenderer((Model)this);
/*  77 */     this.neck5_r1.setRotationPoint(0.0F, -0.3992F, 0.1235F);
/*  78 */     this.neck.addChild(this.neck5_r1);
/*  79 */     setRotationAngle(this.neck5_r1, 0.48F, 0.0F, 0.0F);
/*  80 */     this.neck5_r1.setTextureOffset(29, 65).addBox(-2.5F, -4.0723F, -2.3627F, 5.0F, 4.0F, 5.0F, 0.0F, false);
/*     */     
/*  82 */     this.neck4_r1 = new ModelRenderer((Model)this);
/*  83 */     this.neck4_r1.setRotationPoint(0.0F, -1.9203F, -2.5618F);
/*  84 */     this.neck.addChild(this.neck4_r1);
/*  85 */     setRotationAngle(this.neck4_r1, 0.5672F, 0.0F, 0.0F);
/*  86 */     this.neck4_r1.setTextureOffset(93, 51).addBox(-2.0F, -3.7189F, -0.6203F, 4.0F, 3.0F, 5.0F, 0.0F, false);
/*     */     
/*  88 */     this.neck3_r1 = new ModelRenderer((Model)this);
/*  89 */     this.neck3_r1.setRotationPoint(0.0F, -5.3328F, -2.302F);
/*  90 */     this.neck.addChild(this.neck3_r1);
/*  91 */     setRotationAngle(this.neck3_r1, 0.9599F, 0.0F, 0.0F);
/*  92 */     this.neck3_r1.setTextureOffset(0, 96).addBox(-2.0F, -2.8466F, -1.9423F, 4.0F, 3.0F, 4.0F, -0.01F, false);
/*     */     
/*  94 */     this.neck2_r1 = new ModelRenderer((Model)this);
/*  95 */     this.neck2_r1.setRotationPoint(0.0F, -6.4513F, -4.0017F);
/*  96 */     this.neck.addChild(this.neck2_r1);
/*  97 */     setRotationAngle(this.neck2_r1, 1.2217F, 0.0F, 0.0F);
/*  98 */     this.neck2_r1.setTextureOffset(92, 23).addBox(-2.0F, -2.2568F, -1.8199F, 4.0F, 2.0F, 5.0F, 0.01F, false);
/*     */     
/* 100 */     this.upperMouth = new ModelRenderer((Model)this);
/* 101 */     this.upperMouth.setRotationPoint(0.0F, -7.0F, -8.0F);
/* 102 */     this.head.addChild(this.upperMouth);
/* 103 */     setRotationAngle(this.upperMouth, -0.1309F, 0.0F, 0.0F);
/* 104 */     this.upperMouth.setTextureOffset(0, 35).addBox(-2.0F, -2.4731F, -4.5535F, 4.0F, 3.0F, 2.0F, 0.0F, false);
/* 105 */     this.upperMouth.setTextureOffset(0, 30).addBox(-2.0F, -2.4731F, -6.5535F, 4.0F, 3.0F, 2.0F, 0.01F, false);
/*     */     
/* 107 */     this.upperTeeth = new ModelRenderer((Model)this);
/* 108 */     this.upperTeeth.setRotationPoint(0.0F, -1.4731F, -0.5535F);
/* 109 */     this.upperMouth.addChild(this.upperTeeth);
/* 110 */     this.upperTeeth.setTextureOffset(0, 3).addBox(1.75F, 1.5F, -5.75F, 0.0F, 1.0F, 6.0F, 0.0F, false);
/* 111 */     this.upperTeeth.setTextureOffset(0, 2).addBox(-1.75F, 1.5F, -5.75F, 0.0F, 1.0F, 6.0F, 0.0F, false);
/* 112 */     this.upperTeeth.setTextureOffset(0, 13).addBox(-2.0F, 1.5F, -5.75F, 4.0F, 1.0F, 0.0F, 0.0F, false);
/*     */     
/* 114 */     this.lowerMouth = new ModelRenderer((Model)this);
/* 115 */     this.lowerMouth.setRotationPoint(0.0F, -5.3928F, -11.2171F);
/* 116 */     this.head.addChild(this.lowerMouth);
/* 117 */     setRotationAngle(this.lowerMouth, 0.2182F, 0.0F, 0.0F);
/* 118 */     this.lowerMouth.setTextureOffset(0, 45).addBox(-1.5F, -0.5F, -3.0F, 3.0F, 1.0F, 2.0F, 0.0F, false);
/* 119 */     this.lowerMouth.setTextureOffset(0, 40).addBox(-2.0F, -0.5F, -1.0F, 4.0F, 1.0F, 2.0F, 0.0F, false);
/* 120 */     this.lowerMouth.setTextureOffset(0, 10).addBox(-2.0F, -0.5F, 1.0F, 4.0F, 1.0F, 2.0F, 0.0F, false);
/*     */     
/* 122 */     this.lowerTeeth = new ModelRenderer((Model)this);
/* 123 */     this.lowerTeeth.setRotationPoint(-0.004F, -0.4557F, -1.2455F);
/* 124 */     this.lowerMouth.addChild(this.lowerTeeth);
/* 125 */     this.lowerTeeth.setTextureOffset(8, 44).addBox(-1.756F, -0.5F, 0.4F, 0.0F, 1.0F, 2.0F, 0.0F, false);
/* 126 */     this.lowerTeeth.setTextureOffset(8, 43).addBox(-1.256F, -0.5F, -1.6F, 0.0F, 1.0F, 2.0F, 0.0F, false);
/* 127 */     this.lowerTeeth.setTextureOffset(10, 9).addBox(1.764F, -0.5F, 0.4F, 0.0F, 1.0F, 2.0F, 0.0F, false);
/* 128 */     this.lowerTeeth.setTextureOffset(10, 8).addBox(1.244F, -0.5F, -1.6F, 0.0F, 1.0F, 2.0F, 0.0F, false);
/* 129 */     this.lowerTeeth.setTextureOffset(8, 13).addBox(-1.496F, -0.5F, -1.6F, 3.0F, 1.0F, 0.0F, 0.0F, false);
/*     */     
/* 131 */     this.leftArm = new ModelRenderer((Model)this);
/* 132 */     this.leftArm.setRotationPoint(7.1414F, -1.5F, 0.7938F);
/* 133 */     setRotationAngle(this.leftArm, 0.0F, 0.0F, -0.2618F);
/*     */     
/* 135 */     this.leftArm2_r1 = new ModelRenderer((Model)this);
/* 136 */     this.leftArm2_r1.setRotationPoint(1.0578F, 11.3381F, -2.2409F);
/* 137 */     this.leftArm.addChild(this.leftArm2_r1);
/* 138 */     setRotationAngle(this.leftArm2_r1, -0.0873F, 0.0F, 0.0F);
/* 139 */     this.leftArm2_r1.setTextureOffset(72, 77).addBox(-1.1991F, -4.5881F, -2.0528F, 5.0F, 9.0F, 6.0F, -0.01F, false);
/*     */     
/* 141 */     this.leftArm1_r1 = new ModelRenderer((Model)this);
/* 142 */     this.leftArm1_r1.setRotationPoint(1.3917F, 3.4646F, -2.2409F);
/* 143 */     this.leftArm.addChild(this.leftArm1_r1);
/* 144 */     setRotationAngle(this.leftArm1_r1, 0.1745F, 0.0F, 0.0F);
/* 145 */     this.leftArm1_r1.setTextureOffset(0, 81).addBox(-1.5331F, -4.4646F, -2.0528F, 5.0F, 9.0F, 6.0F, 0.0F, false);
/*     */     
/* 147 */     this.rightArm = new ModelRenderer((Model)this);
/* 148 */     this.rightArm.setRotationPoint(-6.8586F, -1.5F, -1.4562F);
/* 149 */     setRotationAngle(this.rightArm, 0.0F, 0.0F, 0.2618F);
/*     */     
/* 151 */     this.rightArm2_r1 = new ModelRenderer((Model)this);
/* 152 */     this.rightArm2_r1.setRotationPoint(-4.2895F, 11.3116F, -1.0365F);
/* 153 */     this.rightArm.addChild(this.rightArm2_r1);
/* 154 */     setRotationAngle(this.rightArm2_r1, -0.0873F, 0.0F, 0.0F);
/* 155 */     this.rightArm2_r1.setTextureOffset(22, 81).addBox(-0.8519F, -4.5616F, -1.2573F, 5.0F, 9.0F, 6.0F, -0.01F, false);
/*     */     
/* 157 */     this.rightArm1_r1 = new ModelRenderer((Model)this);
/* 158 */     this.rightArm1_r1.setRotationPoint(-3.9555F, 3.4382F, -1.0365F);
/* 159 */     this.rightArm.addChild(this.rightArm1_r1);
/* 160 */     setRotationAngle(this.rightArm1_r1, 0.1745F, 0.0F, 0.0F);
/* 161 */     this.rightArm1_r1.setTextureOffset(83, 59).addBox(-1.1859F, -4.4382F, -1.7573F, 5.0F, 9.0F, 6.0F, 0.0F, false);
/*     */     
/* 163 */     this.rightLeg = new ModelRenderer((Model)this);
/* 164 */     this.rightLeg.setRotationPoint(-6.5F, 8.0F, -1.0F);
/* 165 */     this.rightLeg.setTextureOffset(89, 74).addBox(-2.0F, 12.0F, -3.25F, 4.0F, 4.0F, 5.0F, 0.01F, false);
/*     */     
/* 167 */     this.rightLeg2_r1 = new ModelRenderer((Model)this);
/* 168 */     this.rightLeg2_r1.setRotationPoint(11.5F, 41.6483F, -27.1858F);
/* 169 */     this.rightLeg.addChild(this.rightLeg2_r1);
/* 170 */     setRotationAngle(this.rightLeg2_r1, 0.1745F, 0.0F, 0.0F);
/* 171 */     this.rightLeg2_r1.setTextureOffset(90, 0).addBox(-13.5F, -29.1483F, 28.6858F, 4.0F, 5.0F, 5.0F, 0.0F, false);
/*     */     
/* 173 */     this.rightLeg1_r1 = new ModelRenderer((Model)this);
/* 174 */     this.rightLeg1_r1.setRotationPoint(11.5F, 27.0F, -35.0F);
/* 175 */     this.rightLeg.addChild(this.rightLeg1_r1);
/* 176 */     setRotationAngle(this.rightLeg1_r1, -0.1745F, 0.0F, 0.0F);
/* 177 */     this.rightLeg1_r1.setTextureOffset(88, 86).addBox(-14.0F, -31.0F, 27.0F, 5.0F, 7.0F, 6.0F, 0.0F, false);
/*     */     
/* 179 */     this.leftLeg = new ModelRenderer((Model)this);
/* 180 */     this.leftLeg.setRotationPoint(6.5F, 8.0F, -1.0F);
/* 181 */     this.leftLeg.setTextureOffset(60, 92).addBox(-2.0F, 12.0F, -3.25F, 4.0F, 4.0F, 5.0F, 0.01F, false);
/*     */     
/* 183 */     this.leftLeg2_r1 = new ModelRenderer((Model)this);
/* 184 */     this.leftLeg2_r1.setRotationPoint(11.5F, 41.6483F, -27.1858F);
/* 185 */     this.leftLeg.addChild(this.leftLeg2_r1);
/* 186 */     setRotationAngle(this.leftLeg2_r1, 0.1745F, 0.0F, 0.0F);
/* 187 */     this.leftLeg2_r1.setTextureOffset(92, 13).addBox(-13.5F, -29.1483F, 28.6858F, 4.0F, 5.0F, 5.0F, 0.0F, false);
/*     */     
/* 189 */     this.leftLeg1_r1 = new ModelRenderer((Model)this);
/* 190 */     this.leftLeg1_r1.setRotationPoint(11.5F, 27.0F, -35.0F);
/* 191 */     this.leftLeg.addChild(this.leftLeg1_r1);
/* 192 */     setRotationAngle(this.leftLeg1_r1, -0.1745F, 0.0F, 0.0F);
/* 193 */     this.leftLeg1_r1.setTextureOffset(38, 90).addBox(-14.0F, -31.0F, 27.0F, 5.0F, 7.0F, 6.0F, 0.0F, false);
/*     */     
/* 195 */     this.tail = new ModelRenderer((Model)this);
/* 196 */     this.tail.setRotationPoint(0.0F, 11.5F, 4.1667F);
/* 197 */     setRotationAngle(this.tail, -0.3491F, 0.0F, 0.0F);
/* 198 */     this.tail.setTextureOffset(0, 60).addBox(-3.5F, -1.5F, -0.1667F, 7.0F, 6.0F, 15.0F, -0.01F, false);
/*     */     
/* 200 */     this.tail2 = new ModelRenderer((Model)this);
/* 201 */     this.tail2.setRotationPoint(0.0F, 0.25F, 13.3333F);
/* 202 */     this.tail.addChild(this.tail2);
/* 203 */     setRotationAngle(this.tail2, 0.2182F, 0.0F, 0.0F);
/* 204 */     this.tail2.setTextureOffset(39, 41).addBox(-2.5F, -1.0F, 0.5F, 5.0F, 5.0F, 19.0F, -0.01F, false);
/*     */     
/* 206 */     this.body = new ModelRenderer((Model)this);
/* 207 */     this.body.setRotationPoint(0.0F, 5.8571F, -3.2143F);
/* 208 */     this.body.setTextureOffset(0, 0).addBox(-8.5F, -7.8571F, -4.7857F, 17.0F, 16.0F, 14.0F, 0.0F, false);
/* 209 */     this.body.setTextureOffset(0, 45).addBox(-8.0F, -9.3571F, -4.2857F, 16.0F, 2.0F, 13.0F, 0.0F, false);
/* 210 */     this.body.setTextureOffset(50, 18).addBox(-7.5F, -10.1071F, -3.5357F, 15.0F, 1.0F, 12.0F, 0.0F, false);
/* 211 */     this.body.setTextureOffset(44, 65).addBox(-7.0F, -10.8571F, -3.0357F, 14.0F, 1.0F, 11.0F, 0.0F, false);
/* 212 */     this.body.setTextureOffset(0, 30).addBox(-8.0F, 7.1429F, -4.2857F, 16.0F, 2.0F, 13.0F, 0.0F, false);
/* 213 */     this.body.setTextureOffset(48, 0).addBox(-7.5F, 8.8929F, -3.7857F, 15.0F, 1.0F, 12.0F, 0.0F, false);
/* 214 */     this.body.setTextureOffset(45, 31).addBox(-6.0F, -11.8571F, -2.0357F, 12.0F, 1.0F, 9.0F, 0.0F, false);
/* 215 */     this.body.setTextureOffset(68, 41).addBox(-7.0F, -6.8571F, -5.7857F, 14.0F, 14.0F, 1.0F, 0.0F, false);
/* 216 */     this.body.setTextureOffset(44, 77).addBox(-6.5F, -5.8571F, -6.5357F, 13.0F, 12.0F, 1.0F, 0.0F, false);
/*     */     
/* 218 */     this.bipedBody = this.body;
/* 219 */     this.bipedHead = this.head;
/* 220 */     this.bipedRightArm = this.rightArm;
/* 221 */     this.bipedLeftArm = this.leftArm;
/* 222 */     this.bipedRightLeg = this.rightLeg;
/* 223 */     this.bipedLeftLeg = this.leftLeg;
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void render(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
/* 229 */     this.head.render(matrixStack, buffer, packedLight, packedOverlay);
/* 230 */     this.leftArm.render(matrixStack, buffer, packedLight, packedOverlay);
/* 231 */     this.rightArm.render(matrixStack, buffer, packedLight, packedOverlay);
/* 232 */     this.rightLeg.render(matrixStack, buffer, packedLight, packedOverlay);
/* 233 */     this.leftLeg.render(matrixStack, buffer, packedLight, packedOverlay);
/* 234 */     this.tail.render(matrixStack, buffer, packedLight, packedOverlay);
/* 235 */     this.body.render(matrixStack, buffer, packedLight, packedOverlay);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 315 */     modelRenderer.rotateAngleX = x;
/* 316 */     modelRenderer.rotateAngleY = y;
/* 317 */     modelRenderer.rotateAngleZ = z;
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public void translateHand(HandSide side, MatrixStack matrixStack) {
/* 323 */     super.translateHand(side, matrixStack);
/* 324 */     matrixStack.translate(0.0D, 0.45D, -0.05D);
/* 325 */     matrixStack.rotate(Vector3f.ZP.rotationDegrees((side == HandSide.RIGHT) ? 5.0F : -5.0F));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       
/* 333 */       matrixStack.translate(-0.3D, -0.3D, -0.2D);
/* 334 */       matrixStack.rotate(Vector3f.YP.rotationDegrees(-10.0F));
/* 335 */       matrixStack.rotate(Vector3f.ZP.rotationDegrees(10.0F));
/* 336 */       this.rightArm2_r1.render(matrixStack, vertex, packedLight, overlay, red, green, blue, alpha);
/*     */     }
/*     */     else {
/*     */       
/* 340 */       matrixStack.translate(0.3D, -0.3D, -0.2D);
/* 341 */       matrixStack.rotate(Vector3f.YP.rotationDegrees(-10.0F));
/* 342 */       matrixStack.rotate(Vector3f.ZP.rotationDegrees(-10.0F));
/* 343 */       this.leftArm2_r1.render(matrixStack, vertex, packedLight, overlay, red, green, blue, alpha);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*     */       
/* 352 */       matrixStack.translate(0.2D, -0.5D, 0.4D);
/* 353 */       matrixStack.scale(1.5F, 1.5F, 1.5F);
/* 354 */       matrixStack.rotate(Vector3f.YP.rotationDegrees(-60.0F));
/* 355 */       matrixStack.rotate(Vector3f.XP.rotationDegrees(10.0F));
/* 356 */       this.rightLeg.render(matrixStack, vertex, packedLight, overlay, red, green, blue, alpha);
/*     */     }
/*     */     else {
/*     */       
/* 360 */       matrixStack.translate(-0.3D, -0.5D, 0.3D);
/* 361 */       matrixStack.scale(1.5F, 1.5F, 1.5F);
/* 362 */       matrixStack.rotate(Vector3f.YP.rotationDegrees(60.0F));
/* 363 */       matrixStack.rotate(Vector3f.XP.rotationDegrees(10.0F));
/* 364 */       this.leftLeg.render(matrixStack, vertex, packedLight, overlay, red, green, blue, alpha);
/*     */     } 
/*     */   }
/*     */ }


/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\models\entities\zoans\BrachiosaurusHeavyModel.class
