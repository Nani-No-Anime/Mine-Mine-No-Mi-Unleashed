...
public class CraftingEvents
{
  ...
  public static void onAnvilUpdate(AnvilUpdateEvent event) {
    if (ItemsHelper.isBow(event.getLeft())) {
      ...
      else if (event.getRight().getItem() == ModBlocks.IMPACT_DIAL.asItem() && event.getRight().getCount() >= 5 && 1 > EnchantmentHelper.getEnchantmentLevel(ModEnchantments.DIAL_IMPACT, event.getLeft())) {
