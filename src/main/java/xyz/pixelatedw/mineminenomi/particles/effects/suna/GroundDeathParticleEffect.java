...
/*    */         
/* 29 */         motionX = WyHelper.randomDouble() / 3.0D;
/* 30 */         motionY = 0.0D;
/* 31 */         motionZ = WyHelper.randomDouble() / 3.0D;
/*    */         
/* 33 */         GenericParticleData data = new GenericParticleData(ModParticleTypes.SUNA2);
/* 34 */         data.setLife(10);
...
/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\particles\effects\suna\GroundDeathParticleEffect.class
