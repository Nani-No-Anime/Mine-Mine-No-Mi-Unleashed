...
/*    */       
/* 25 */       motionX *= middlePoint / 7.0D;
/* 26 */       motionY *= middlePoint / 7.0D;
/* 27 */       motionZ *= middlePoint / 7.0D;
/*    */       
/* 29 */       GenericParticleData data = new GenericParticleData(ModParticleTypes.RUST);
/* 30 */       data.setLife(10);
/* 31 */       data.setSize(1.0F);
/* 32 */       data.setMotion(motionX, motionY + 0.08D, motionZ);
...
/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\particles\effects\sabi\RustTouchParticleEffect.class
