...
/*  28 */     super((new Item.Properties()).group(ModCreativeTabs.WEAPONS).maxStackSize(1).defaultMaxDamage(maxDamage));
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/*  93 */     this.ammoItems = new ArrayList<>(Arrays.asList(new Item[] { ModItems.POP_GREEN, ModItems.POP_GREEN_DEVIL, ModItems.POP_GREEN_TAKE_JAVELIN, ModItems.POP_GREEN_RAFFLESIA, ModItems.POP_GREEN_BAKUHATSU_SO, ModItems.POP_GREEN_HUMANDRAKE, ModItems.POP_GREEN_TRAMPOLIA, ModItems.POP_GREEN_IMPACT_WOLF }));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 101 */     return itemStack -> this.ammoItems.contains(itemStack.getItem());
/*     */   }
/*     */   
...
/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\items\weapons\PopGreenBowItem.class
