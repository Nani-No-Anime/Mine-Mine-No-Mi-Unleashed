...
public class MilkyDialItem
  ...
  public MilkyDialItem() {
    super(ModBlocks.MILKY_DIAL, (new Item.Properties()).group(ModCreativeTabs.MISC).maxStackSize(16));
  }
  ...
  public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity player, Hand hand) {
    if (!world.isRemote) {
      ...
      MilkyDialProjectile proj = new MilkyDialProjectile(player.world, (LivingEntity)player);
