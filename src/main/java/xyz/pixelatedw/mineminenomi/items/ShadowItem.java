  ...
  public ItemStack onItemUseFinish(ItemStack itemStack, World world, LivingEntity entity) {
    if (!world.isRemote && entity instanceof PlayerEntity) {
      ...
      if (!props.hasShadow()) {
        ...
        WyNetwork.sendToAllTrackingAndSelf(new SSyncEntityStatsPacket(entity.getEntityId(), props), entity);

      
      }
      else if (entity.getActivePotionEffect(Effects.STRENGTH) == null || entity.getActivePotionEffect(Effects.RESISTANCE) == null) {
