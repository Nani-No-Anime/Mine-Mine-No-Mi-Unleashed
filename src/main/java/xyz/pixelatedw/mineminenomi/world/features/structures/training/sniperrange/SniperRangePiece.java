  ...
  extends TemplateStructurePiece
{
  ...
  public SniperRangePiece(TemplateManager template, CompoundNBT nbt) {
    super(ModFeatures.Pieces.SNIPER_RANGE_PIECE, nbt);
  ...
  public SniperRangePiece(TemplateManager template, BlockPos pos, Rotation rot) {
    super(ModFeatures.Pieces.SNIPER_RANGE_PIECE, 0);
    this.templatePosition = pos;
    this.rotation = rot;
    this.resourceLocation = new ResourceLocation("mineminenomi", "unaligned/sniper_range");
    build(template);
  }
  ...
  protected void handleDataMarker(String function, BlockPos pos, IWorld world, Random rand, MutableBoundingBox sbb) {
    if (function.equals("trainer_spawn")) {
      ...
      if (spawner instanceof CustomSpawnerTileEntity) {
        ...
        ((CustomSpawnerTileEntity)spawner).setSpawnerMob(ModEntities.SNIPER_TRAINER);
      } 
    } 
  }
