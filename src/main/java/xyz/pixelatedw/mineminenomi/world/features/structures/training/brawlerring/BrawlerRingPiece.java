  ...
  extends TemplateStructurePiece
{
  ...
  public BrawlerRingPiece(TemplateManager template, CompoundNBT nbt) {
    super(ModFeatures.Pieces.BRAWLER_RING_PIECE, nbt);
  ...
  public BrawlerRingPiece(TemplateManager template, BlockPos pos, Rotation rot) {
    super(ModFeatures.Pieces.BRAWLER_RING_PIECE, 0);
    this.templatePosition = pos;
    this.rotation = rot;
    this.resourceLocation = new ResourceLocation("mineminenomi", "unaligned/brawler_ring");
    build(template);
  }
  ...
  protected void handleDataMarker(String function, BlockPos pos, IWorld world, Random rand, MutableBoundingBox sbb) {
    if (function.equals("trainer_spawn")) {
      ...
      if (spawner instanceof CustomSpawnerTileEntity) {
        ...
        ((CustomSpawnerTileEntity)spawner).setSpawnerMob(ModEntities.BRAWLER_TRAINER);
      } 
    } 
  }
