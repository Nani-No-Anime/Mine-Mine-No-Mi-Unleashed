...
/*  40 */     return (new ResourceLocation("mineminenomi", "marine_camp")).toString();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       
/*  91 */       Structure structure = ModFeatures.MARINE_CAMP;
...
/* 110 */       MarineCampPieces.addComponents(templateManagerIn, blockpos, new Random(), this.components);
/* 111 */       recalculateStructureSize();
/* 112 */       StructuresHelper.SPAWNED_STRUCTURES.add(blockpos);
/* 113 */       StructuresHelper.STRUCTURES_COUNT[12] = StructuresHelper.STRUCTURES_COUNT[12] + 1;
/*     */       
/* 115 */       WyDebug.debug("Marine Camp spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\camp\marine\MarineCampStructure.class
