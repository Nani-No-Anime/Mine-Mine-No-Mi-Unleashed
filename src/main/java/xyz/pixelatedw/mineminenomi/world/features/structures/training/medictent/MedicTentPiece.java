  ...
  extends TemplateStructurePiece
{
  ...
  public MedicTentPiece(TemplateManager template, CompoundNBT nbt) {
    super(ModFeatures.Pieces.MEDIC_TENT_PIECE, nbt);
  ...
  public MedicTentPiece(TemplateManager template, BlockPos pos, Rotation rot) {
    super(ModFeatures.Pieces.MEDIC_TENT_PIECE, 0);
    this.templatePosition = pos;
    this.rotation = rot;
    this.resourceLocation = new ResourceLocation("mineminenomi", "unaligned/medic_tent");
    build(template);
  }
  ...
  protected void handleDataMarker(String function, BlockPos pos, IWorld world, Random rand, MutableBoundingBox sbb) {
    if (function.equals("trainer_spawn")) {
      ...
      if (spawner instanceof CustomSpawnerTileEntity) {
        ...
        ((CustomSpawnerTileEntity)spawner).setSpawnerMob(ModEntities.DOCTOR_TRAINER);
      } 
    } 
  }
