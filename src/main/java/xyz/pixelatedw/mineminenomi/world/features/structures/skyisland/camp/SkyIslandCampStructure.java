  ...
  extends OPStructure<NoFeatureConfig>
{
  ...
  public String getStructureName() {
    return (new ResourceLocation("mineminenomi", "sky_island_camp")).toString();
  }
  ...
  public static void register(Biome biome) {
    ...
    if (biome.getCategory() != Biome.Category.NETHER && biome.getCategory() != Biome.Category.THEEND) {
      ...
      Structure structure = ModFeatures.SKY_ISLAND_CAMP;
    ...
    extends StructureStart
  {
    ...
    public void init(ChunkGenerator<?> generator, TemplateManager templateManager, int chunkX, int chunkZ, Biome biome) {
      ...
      SkyIslandCampPieces.addComponents(this.templateManager, blockpos, this.components);
      ...
      WyDebug.debug("Sky Island Camp spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
    }
  }
}
