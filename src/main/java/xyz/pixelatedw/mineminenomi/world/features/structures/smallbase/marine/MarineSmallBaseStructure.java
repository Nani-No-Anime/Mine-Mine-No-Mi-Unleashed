  ...
  extends OPStructure<NoFeatureConfig>
{
  ...
  public static void register(Biome biome) {
    ...
    if (biome.getCategory() == Biome.Category.PLAINS || biome.getCategory() == Biome.Category.BEACH || biome.getCategory() == Biome.Category.FOREST || biome.getCategory() == Biome.Category.MESA || biome.getCategory() == Biome.Category.SAVANNA) {
      ...
      Structure structure = ModFeatures.MARINE_SMALL_BASE;
    ...
    extends OPStructure.OPStructureStart
  {
    ...
    public void init(ChunkGenerator<?> generator, TemplateManager templateManager, int chunkX, int chunkZ, Biome biome) {
      ...
      if (i2 >= 60) {
        ...
        MarineSmallBasePieces.addComponents(this.templateManager, blockpos, this.components);
        ...
        WyDebug.debug("Marine Small Base spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
      } 
    }
  }
}
