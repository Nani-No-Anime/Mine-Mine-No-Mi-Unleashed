...
/*  41 */     return (new ResourceLocation("mineminenomi", "pirate_ship_large")).toString();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       
/*  92 */       Structure structure = ModFeatures.PIRATE_LARGE_SHIP;
...
/* 108 */       int i = chunkX * 16;
/* 109 */       int j = chunkZ * 16;
/* 110 */       BlockPos blockpos = new BlockPos(i, generator.getSeaLevel() - 7, j);
/* 111 */       Rotation rotation = Rotation.values()[this.rand.nextInt((Rotation.values()).length)];
/* 112 */       PirateLargeShipPieces.addComponents(templateManagerIn, blockpos, rotation, this.components);
/* 113 */       recalculateStructureSize();
/* 114 */       StructuresHelper.SPAWNED_STRUCTURES.add(blockpos);
/* 115 */       StructuresHelper.STRUCTURES_COUNT[2] = StructuresHelper.STRUCTURES_COUNT[2] + 1;
/*     */       
/* 117 */       WyDebug.debug("Pirate Large Ship spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\largeship\pirate\PirateLargeShipStructure.class
