...
/* 34 */     super(ModFeatures.Pieces.SWORDSMAN_DOJO_PIECE, nbt);
...
/* 42 */     super(ModFeatures.Pieces.SWORDSMAN_DOJO_PIECE, 0);
/* 43 */     this.templatePosition = pos;
/* 44 */     this.rotation = rot;
/* 45 */     this.resourceLocation = new ResourceLocation("mineminenomi", "unaligned/swordsman_dojo");
/* 46 */     build(template);
/*    */   }
/*    */ 
/*    */ 
...
/* 74 */         ((CustomSpawnerTileEntity)spawner).setSpawnerMob(ModEntities.SWORDSMAN_TRAINER);
/*    */       } 
/*    */     } 
/*    */   }
/*    */ 
...
/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\training\swordsmandojo\SwordsmanDojoPiece.class
