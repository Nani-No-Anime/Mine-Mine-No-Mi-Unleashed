...
/*  41 */     return (new ResourceLocation("mineminenomi", "medic_tent")).toString();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       return;
/*     */     }
/*  90 */     if (biome.getCategory() == Biome.Category.PLAINS || biome.getCategory() == Biome.Category.BEACH || biome.getCategory() == Biome.Category.SAVANNA || biome.getCategory() == Biome.Category.MESA || biome.getCategory() == Biome.Category.DESERT) {
/*     */       
/*  92 */       Structure structure = ModFeatures.MEDIC_TENT;
...
/* 112 */       this.components.add(new MedicTentPiece(templateManager, blockpos, rotation));
...
/*     */       
/* 117 */       WyDebug.debug("Medic Tent spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\training\medictent\MedicTentStructure.class
