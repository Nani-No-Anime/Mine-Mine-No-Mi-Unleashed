  ...
  extends OPStructure<NoFeatureConfig>
{
  ...
  public String getStructureName() {
    return (new ResourceLocation("mineminenomi", "medic_tent")).toString();
  }
  ...
  public static void register(Biome biome) {
    ...
    if (biome.getCategory() == Biome.Category.PLAINS || biome.getCategory() == Biome.Category.BEACH || biome.getCategory() == Biome.Category.SAVANNA || biome.getCategory() == Biome.Category.MESA || biome.getCategory() == Biome.Category.DESERT) {
      
      Structure structure = ModFeatures.MEDIC_TENT;
    ...
    extends StructureStart
  {
    ...
    public void init(ChunkGenerator<?> generator, TemplateManager templateManager, int chunkX, int chunkZ, Biome biome) {
      ...
      this.components.add(new MedicTentPiece(templateManager, blockpos, rotation));
      ...
      WyDebug.debug("Medic Tent spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
    }
  }
}
