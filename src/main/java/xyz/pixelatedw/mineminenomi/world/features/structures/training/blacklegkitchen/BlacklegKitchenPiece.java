  ...
  extends TemplateStructurePiece
{
  ...
  public BlacklegKitchenPiece(TemplateManager template, CompoundNBT nbt) {
    super(ModFeatures.Pieces.BLACKLEG_KITCHEN_PIECE, nbt);
  ...
  public BlacklegKitchenPiece(TemplateManager template, BlockPos pos, Rotation rot) {
    super(ModFeatures.Pieces.BLACKLEG_KITCHEN_PIECE, 0);
    this.templatePosition = pos;
    this.rotation = rot;
    this.resourceLocation = new ResourceLocation("mineminenomi", "unaligned/blackleg_kitchen");
    build(template);
  }
  ...
  protected void handleDataMarker(String function, BlockPos pos, IWorld world, Random rand, MutableBoundingBox sbb) {
    if (function.equals("trainer_spawn")) {
      ...
      if (spawner instanceof CustomSpawnerTileEntity) {
        ...
        ((CustomSpawnerTileEntity)spawner).setSpawnerMob(ModEntities.BLACK_LEG_TRAINER);
      } 
    } 
  }
