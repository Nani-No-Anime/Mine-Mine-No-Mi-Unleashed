...
public class BanditCampPieces
{
    ...
    extends TemplateStructurePiece
  {
    ...
    private void build(TemplateManager templateManager) {
      ...
      PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE).setCenterOffset((BlockPos)BanditCampPieces.CENTER_OFFSET.get(this.resourceLocation)).addProcessor(this.processor);
