  ...
  extends OPStructure<NoFeatureConfig>
{
  ...
  public String getStructureName() {
    return (new ResourceLocation("mineminenomi", "brawler_ring")).toString();
  }
  ...
  public static void register(Biome biome) {
    ...
    if (biome.getCategory() == Biome.Category.PLAINS || biome.getCategory() == Biome.Category.BEACH || biome.getCategory() == Biome.Category.SAVANNA) {
      
      Structure structure = ModFeatures.BRAWLER_RING;
    ...
    extends StructureStart
  {
    ...
    public void init(ChunkGenerator<?> generator, TemplateManager templateManager, int chunkX, int chunkZ, Biome biome) {
      ...
      this.components.add(new BrawlerRingPiece(templateManager, blockpos.add(0, -2, 0), rotation));
      ...
      WyDebug.debug("Brawler Ring spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
    }
  }
}
