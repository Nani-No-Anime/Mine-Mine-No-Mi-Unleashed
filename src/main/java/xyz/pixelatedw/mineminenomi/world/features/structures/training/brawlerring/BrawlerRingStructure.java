...
/*     */ 
/*     */ 
/*     */ public class BrawlerRingStructure
/*     */   extends OPStructure<NoFeatureConfig>
/*     */ {
/*     */   public BrawlerRingStructure() {
...
/*  41 */     return (new ResourceLocation("mineminenomi", "brawler_ring")).toString();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       return;
/*     */     }
/*  90 */     if (biome.getCategory() == Biome.Category.PLAINS || biome.getCategory() == Biome.Category.BEACH || biome.getCategory() == Biome.Category.SAVANNA) {
/*     */       
/*  92 */       Structure structure = ModFeatures.BRAWLER_RING;
...
/* 112 */       this.components.add(new BrawlerRingPiece(templateManager, blockpos.add(0, -2, 0), rotation));
...
/*     */       
/* 117 */       WyDebug.debug("Brawler Ring spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\training\brawlerring\BrawlerRingStructure.class
