...
/*     */ 
/*     */ 
/*     */ public class PirateSmallShipStructure
...
/*  41 */     return (new ResourceLocation("mineminenomi", "pirate_ship_small")).toString();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  72 */     boolean canSpawn = CommonConfig.INSTANCE.canSpawnSmallShips();
/*  73 */     boolean isFlat = WyHelper.isSurfaceFlat(chunkGen, chunkX, chunkZ, 3);
/*  74 */     boolean isChance = (MathHelper.clamp(WyHelper.randomWithRange(0, 100) + WyHelper.randomDouble(), 0.0D, 100.0D) < CommonConfig.INSTANCE.getChanceForSmallShipsSpawn());
/*     */     
...
/*  87 */     if (!CommonConfig.INSTANCE.canSpawnSmallShips()) {
/*     */       return;
/*     */     }
/*  90 */     if (biome.getCategory() == Biome.Category.OCEAN) {
/*     */       
/*  92 */       Structure structure = ModFeatures.PIRATE_SMALL_SHIP;
...
/* 108 */       int i = chunkX * 16;
/* 109 */       int j = chunkZ * 16;
/* 110 */       BlockPos blockpos = new BlockPos(i, generator.getSeaLevel() - 5, j);
/* 111 */       PirateSmallShipPieces.addComponents(templateManagerIn, blockpos, Rotation.randomRotation(new Random()), this.components);
/* 112 */       recalculateStructureSize();
/* 113 */       StructuresHelper.SPAWNED_STRUCTURES.add(blockpos);
/* 114 */       StructuresHelper.STRUCTURES_COUNT[0] = StructuresHelper.STRUCTURES_COUNT[0] + 1;
/*     */       
/* 116 */       WyDebug.debug("Pirate Small Ship spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\smallship\pirate\PirateSmallShipStructure.class
