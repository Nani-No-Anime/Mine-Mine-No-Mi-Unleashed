  ...
  extends OPStructure<NoFeatureConfig>
{
  ...
  public String getStructureName() {
    return (new ResourceLocation("mineminenomi", "pirate_ship_small")).toString();
  }
  ...
  public boolean canBeGenerated(BiomeManager biomeManager, ChunkGenerator<?> chunkGen, Random rand, int chunkX, int chunkZ, Biome biome) {
    boolean canSpawn = CommonConfig.INSTANCE.canSpawnSmallShips();
    boolean isFlat = WyHelper.isSurfaceFlat(chunkGen, chunkX, chunkZ, 3);
    boolean isChance = (MathHelper.clamp(WyHelper.randomWithRange(0, 100) + WyHelper.randomDouble(), 0.0D, 100.0D) < CommonConfig.INSTANCE.getChanceForSmallShipsSpawn());
  ...
  public static void register(Biome biome) {
    ...
    if (biome.getCategory() == Biome.Category.OCEAN) {
      ...
      Structure structure = ModFeatures.PIRATE_SMALL_SHIP;
    ...
    extends StructureStart
  {
    ...
    public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biome) {
      int i = chunkX * 16;
      int j = chunkZ * 16;
      BlockPos blockpos = new BlockPos(i, generator.getSeaLevel() - 5, j);
      ...
      StructuresHelper.STRUCTURES_COUNT[0] = StructuresHelper.STRUCTURES_COUNT[0] + 1;
