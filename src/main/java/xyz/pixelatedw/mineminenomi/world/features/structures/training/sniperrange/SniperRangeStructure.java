...
/*  41 */     return (new ResourceLocation("mineminenomi", "sniper_range")).toString();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       
/*  92 */       Structure structure = ModFeatures.SNIPER_RANGE;
...
/* 112 */       this.components.add(new SniperRangePiece(templateManager, blockpos.add(0, -1, 0), rotation));
...
/*     */       
/* 117 */       WyDebug.debug("Sniper Range spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\training\sniperrange\SniperRangeStructure.class
