...
/*  41 */     return (new ResourceLocation("mineminenomi", "marine_large_base")).toString();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       
/*  91 */       Structure structure = ModFeatures.MARINE_LARGE_BASE;
...
/* 120 */       if (i2 >= 60) {
/*     */         
/* 122 */         BlockPos blockpos = new BlockPos(chunkX * 16 + 8, i2 - 3, chunkZ * 16 + 8);
/* 123 */         MarineLargeBasePieces.addComponents(this.templateManager, blockpos, this.components);
/* 124 */         recalculateStructureSize();
/* 125 */         StructuresHelper.SPAWNED_STRUCTURES.add(blockpos);
/* 126 */         StructuresHelper.STRUCTURES_COUNT[6] = StructuresHelper.STRUCTURES_COUNT[6] + 1;
/*     */         
/* 128 */         WyDebug.debug("Marine Large Base spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
/*     */       } 
/*     */     }
/*     */   }
/*     */ }
...
/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\largebase\marine\MarineLargeBaseStructure.class
