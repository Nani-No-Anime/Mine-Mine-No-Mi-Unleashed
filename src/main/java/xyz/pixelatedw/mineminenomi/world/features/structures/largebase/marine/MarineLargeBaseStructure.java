  ...
  extends OPStructure<NoFeatureConfig>
{
  ...
  public String getStructureName() {
    return (new ResourceLocation("mineminenomi", "marine_large_base")).toString();
  }
  ...
  public static void register(Biome biome) {
    ...
    if (biome.getCategory() == Biome.Category.PLAINS || biome.getCategory() == Biome.Category.BEACH || biome.getCategory() == Biome.Category.FOREST || biome.getCategory() == Biome.Category.SAVANNA) {
      ...
      Structure structure = ModFeatures.MARINE_LARGE_BASE;
    ...
    extends OPStructure.OPStructureStart
  {
    ...
    public void init(ChunkGenerator<?> generator, TemplateManager templateManager, int chunkX, int chunkZ, Biome biome) {
      ...
      if (i2 >= 60) {
        ...
        BlockPos blockpos = new BlockPos(chunkX * 16 + 8, i2 - 3, chunkZ * 16 + 8);
        ...
        StructuresHelper.STRUCTURES_COUNT[6] = StructuresHelper.STRUCTURES_COUNT[6] + 1;
