  ...
  extends OPStructure<NoFeatureConfig>
{
  ...
  public String getStructureName() {
    return (new ResourceLocation("mineminenomi", "sky_island_town")).toString();
  }
  ...
  public static void register(Biome biome) {
    ...
    if (biome.getCategory() != Biome.Category.NETHER && biome.getCategory() != Biome.Category.THEEND) {
      ...
      Structure structure = ModFeatures.SKY_ISLAND_TOWN;
    ...
    extends StructureStart
  {
    ...
    public void init(ChunkGenerator<?> generator, TemplateManager templateManager, int chunkX, int chunkZ, Biome biome) {
      ...
      int i = chunkX * 16;
      int j = chunkZ * 16;
      BlockPos blockpos = new BlockPos(i, WyHelper.randomWithRange(160, 180), j);
      SkyIslandTownPieces.addComponents(this.templateManager, blockpos, this.components);
      ...
      WyDebug.debug("Sky Island Town spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
    }
  }
}
