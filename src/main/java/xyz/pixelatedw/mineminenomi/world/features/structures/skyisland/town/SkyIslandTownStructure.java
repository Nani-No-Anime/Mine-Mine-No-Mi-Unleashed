...
/*     */ 
/*     */ 
/*     */ public class SkyIslandTownStructure
/*     */   extends OPStructure<NoFeatureConfig>
/*     */ {
/*     */   public SkyIslandTownStructure() {
...
/*  40 */     return (new ResourceLocation("mineminenomi", "sky_island_town")).toString();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       
/*  90 */       Structure structure = ModFeatures.SKY_ISLAND_TOWN;
...
/* 109 */       int i = chunkX * 16;
/* 110 */       int j = chunkZ * 16;
/* 111 */       BlockPos blockpos = new BlockPos(i, WyHelper.randomWithRange(160, 180), j);
/* 112 */       SkyIslandTownPieces.addComponents(this.templateManager, blockpos, this.components);
...
/*     */       
/* 117 */       WyDebug.debug("Sky Island Town spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\skyisland\town\SkyIslandTownStructure.class
