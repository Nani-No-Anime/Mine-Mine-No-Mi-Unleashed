...
public class SkyIslandTownPieces
{
    ...
    extends TemplateStructurePiece
  {
    ...
    public Piece(TemplateManager template, ResourceLocation res, BlockPos pos, StructureProcessor proc) {
      ...
      BlockPos blockpos = (BlockPos)SkyIslandTownPieces.POSITION_OFFSET.get(this.resourceLocation);
    ...
    private void build(TemplateManager templateManager) {
      ...
      PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE).setCenterOffset((BlockPos)SkyIslandTownPieces.CENTER_OFFSET.get(this.resourceLocation)).addProcessor(this.processor);
    ...
    public boolean create(IWorld world, ChunkGenerator<?> generator, Random random, MutableBoundingBox bb, ChunkPos chunkPos) {
      ...
      PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE).setCenterOffset((BlockPos)SkyIslandTownPieces.CENTER_OFFSET.get(this.resourceLocation)).addProcessor(this.processor);
      BlockPos offset = (BlockPos)SkyIslandTownPieces.POSITION_OFFSET.get(this.resourceLocation);
