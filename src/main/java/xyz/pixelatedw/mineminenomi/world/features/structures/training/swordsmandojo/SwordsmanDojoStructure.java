...
/*     */ 
/*     */ 
/*     */ public class SwordsmanDojoStructure
/*     */   extends OPStructure<NoFeatureConfig>
/*     */ {
/*     */   public SwordsmanDojoStructure() {
...
/*  41 */     return (new ResourceLocation("mineminenomi", "swordsman_dojo")).toString();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       return;
/*     */     }
/*  90 */     if (biome.getCategory() == Biome.Category.PLAINS || biome.getCategory() == Biome.Category.DESERT) {
/*     */       
/*  92 */       Structure structure = ModFeatures.SWORDSMAN_DOJO;
...
/* 112 */       this.components.add(new SwordsmanDojoPiece(templateManager, blockpos, rotation));
...
/*     */       
/* 117 */       WyDebug.debug("Dojo spawned at: /tp " + blockpos.getX() + " ~ " + blockpos.getZ());
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\world\features\structures\training\swordsmandojo\SwordsmanDojoStructure.class
