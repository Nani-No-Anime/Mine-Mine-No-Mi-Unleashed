  ...
  extends OPStructure<NoFeatureConfig>
{
  ...
  public String getStructureName() {
    return (new ResourceLocation("mineminenomi", "swordsman_dojo")).toString();
  }
  ...
  public static void register(Biome biome) {
    ...
    if (biome.getCategory() == Biome.Category.PLAINS || biome.getCategory() == Biome.Category.DESERT) {
      ...
      Structure structure = ModFeatures.SWORDSMAN_DOJO;
    ...
    extends StructureStart
  {
    ...
    public void init(ChunkGenerator<?> generator, TemplateManager templateManager, int chunkX, int chunkZ, Biome biome) {
      ...
      this.components.add(new SwordsmanDojoPiece(templateManager, blockpos, rotation));
