...
public class EntityStatsBase implements IEntityStats {
  ...
  public void alterDoriki(int value) { this.doriki = MathHelper.clamp(this.doriki + value, 0, CommonConfig.INSTANCE.getDorikiLimit()); }
  ...
  public long getBelly() { return this.belly; }

  public void alterBelly(long value) { this.belly = WyHelper.clamp(this.belly + value, 0L, 999999999L); }

  public void setBelly(long value) { this.belly = value; }

  public long getExtol() { return this.extol; }

  public void alterExtol(long value) { this.extol = WyHelper.clamp(this.extol + value, 0L, 999999999L); }

  public void setExtol(long value) { this.extol = value; }

  public long getBounty() { return this.bounty; }

  public void alterBounty(long value) { this.bounty = WyHelper.clamp(this.bounty + value, 0L, 100000000000L); }

  public void setBounty(long value) { this.bounty = value; }

  public int getCola() { return this.cola; }

  public void alterCola(int value) { this.cola = MathHelper.clamp(this.cola + value, 0, getMaxCola()); }

  public void setCola(int value) { this.cola = value; }
  ...
  public void setMaxCola(int value) { this.maxCola = value; }

  public int getUltraCola() { return this.ultraCola; }
  ...
  public void addUltraCola(int value) { this.ultraCola += value; }

  public int getLoyalty() { return this.loyalty; }

  public void alterLoyalty(int value) { this.loyalty = MathHelper.clamp(this.loyalty + value, 0, 100); }

  public void setLoyalty(int value) { this.loyalty = value; }
  ...
  public void setFaction(String value) { this.faction = WyHelper.getResourceName(value); }
  ...
  public void setRace(String value) { this.race = WyHelper.getResourceName(value); }
  ...
  public void setFightingStyle(String value) { this.fightingStyle = value; }

  public String getFightingStyle() { return this.fightingStyle; }

  public boolean hasShadow() { return this.hasShadow; }

  public void setShadow(boolean value) { this.hasShadow = value; }

  public boolean hasHeart() { return this.hasHeart; }

  public void setHeart(boolean value) { this.hasHeart = value; }

  public boolean isInCombatMode() { return this.inCombatMode; }

  public void setCombatMode(boolean value) { this.inCombatMode = value; }

  public boolean hasStrawDoll() { return this.hasStrawDoll; }

  public void setStrawDoll(boolean value) { this.hasStrawDoll = value; }
  ...
  public boolean isBunnyMink() { return this.subRace.equalsIgnoreCase("mink_bunny"); }

  public boolean isDogMink() { return this.subRace.equalsIgnoreCase("mink_dog"); }

  public boolean isLionMink() { return this.subRace.equalsIgnoreCase("mink_lion"); }

  public void setSubRace(String value) { this.subRace = value; }

  public String getSubRace() { return this.subRace; }

  public boolean isRogue() { return this.isRogue; }

  public void setRogue(boolean value) { this.isRogue = value; }
}
