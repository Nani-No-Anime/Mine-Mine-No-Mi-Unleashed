...
/* 19 */   public static final Ability INSTANCE = (Ability)new DoruDoruArtsPickaxeAbility();
/*    */ 
/*    */   
/*    */   public DoruDoruArtsPickaxeAbility() {
/* 23 */     super("Doru Doru Arts: Pickaxe", AbilityHelper.getDevilFruitCategory());
/* 24 */     setDescription("The user uses hardened wax to create a pickaxe");
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/* 37 */     ItemStack itemStack = new ItemStack((IItemProvider)ModWeapons.DORU_PICKAXE);
/* 38 */     float red = 1.0F;
/* 39 */     float green = 1.0F;
/* 40 */     float blue = 1.0F;
...
/* Location:              C:\Users\4tuto\curseforge\minecraft\Instances\incontrol\mods\mine-mine-no-mi-1.15.2-0.8.1.jar!\xyz\pixelatedw\mineminenomi\abilities\doru\DoruDoruArtsPickaxeAbility.class
