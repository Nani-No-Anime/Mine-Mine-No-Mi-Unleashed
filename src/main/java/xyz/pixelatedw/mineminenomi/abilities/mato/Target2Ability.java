...
public class Target2Ability extends Ability {
  public static final Ability INSTANCE = new Target2Ability();

  
  public Target2Ability() {
    super("Target2", AbilityHelper.getDevilFruitCategory());
  ...
  private boolean onUseEvent(PlayerEntity player) {
    ItemStack it = player.getHeldItemOffhand();
    ...
    if (it == null || it == new ItemStack((IItemProvider)Blocks.AIR) || it == new ItemStack(null)) {
      ...
      player.sendMessage((ITextComponent)new StringTextComponent("You must be holding an object in your off hand to use the target ability !"));
    }
